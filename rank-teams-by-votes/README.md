<h2>1366. Rank Teams by Votes</h2><h3>Medium</h3><hr><div><p>In a special ranking system,&nbsp;each voter gives a rank from highest to lowest to all teams participated in the competition.</p>
