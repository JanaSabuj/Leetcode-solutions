<h2>873. Length of Longest Fibonacci Subsequence</h2><h3>Medium</h3><hr><div><p>A sequence <code>x<sub>1</sub>, x<sub>2</sub>, ..., x<sub>n</sub></code> is <em>Fibonacci-like</em> if:</p>
